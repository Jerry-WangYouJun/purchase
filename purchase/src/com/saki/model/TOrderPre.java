 ...
 */
@Entity
@Table(name = "t_order_copy")

public class TOrderPre implements java.io.Serializable {
	...
	/** full constructor */
	public TOrderPre(Integer confirmId ,Integer companyId, Integer addressId ,String orderNo, Date startDate, String confirmDate, Date pillDate, Date endDate,
