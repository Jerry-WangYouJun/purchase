...
<script type="text/javascript">
	function importImg() {
		...
		$('#ImportForm')
				.ajaxSubmit(
						{
							url : '${pageContext.request.contextPath}/report!importColorImage.action?filename='
									+ filename,
							dataType : 'text',
...
<body>
	...
	<form id="ImportForm" action="${pageContext.request.contextPath}/report!importExcel.action"
			 ...
			 <div class="control-group">
				 <div class="controls">
					 	<label>品牌名</label> <input name="brand" value="${color.brand}">
				 </div>
			 </div>
			  <div class="control-group">
				 <div class="controls">
					 	<label>色卡描述</label> <input name="descrip" value="${color.descrip}">
				 </div>
			 </div>
		<div class="control-group">
			<div class="controls">
